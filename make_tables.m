...
iterations = 100; % iterations aguirregabira mira

% estimate everything

generate_table(beta,choices,data,states,iterations)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ........................... FUNCTIONS ..................................%

function generate_table(beta,choices,data,states,iterations)

% this function generates table 3 for Joan's notes. 
...
% Get Rust Hotz Miller

disp("Estimating Hotz and Miller")
it = 1;
disp("Hotz Miller Groups 1-3")
[thetaccp13,stdccp13]=get_estimates_aguirre(index13,beta,choices,data,states,it);
disp("Hotz Miller Group 4")
[thetaccp4,stdccp4]=get_estimates_aguirre(index4,beta,choices,data,states,it);
disp("Hotz Miller Groups 1-4")
[thetaccp14,stdccp14]=get_estimates_aguirre(index14,beta,choices,data,states,it);

% Get Rust Aguirregabira Mira
disp("Estimating Aguirregabira Mira")
disp("Aguirregabira Mira Groups 1-3")
[thetaagui13,stdagui13]=get_estimates_aguirre(index13,beta,choices,data,states,iterations);
disp("Aguirregabira Mira Group 4")
[thetaagui4,stdagui4]=get_estimates_aguirre(index4,beta,choices,data,states,iterations);
disp("Aguirregabira Mira Groups 1-4")
[thetaagui14,stdagui14]=get_estimates_aguirre(index14,beta,choices,data,states,iterations);
...
group13 = get_output_all(thetahat13,thetaccp13,thetaagui13,stdtheta13,stdccp13,stdagui13);
group4 = get_output_all(thetahat4,thetaccp4,thetaagui4,stdtheta4,stdccp4,stdagui4);
group14 = get_output_all(thetahat14,thetaccp14,thetaagui14,stdtheta14,stdccp14,stdagui14);

thetas = ["ThetaR";"Std Error";"Theta1";"Std Error";"ThetaR";"Std Error";"Theta1";"Std Error";"ThetaR";"Std Error";"Theta1";"Std Error"];
outall = table(thetas,group13,group4,group14,'VariableNames',varnames)
saveTableToLatex(outall, 'Output/allmethods.tex')
...
function out = get_output_all(thetarust,thetaccp,thetaagui,stdrust,stdccp,stdagui)
...
function [thetahat,stdtheta] = get_estimates_aguirre(index,beta,choices,data,states,iterations)
